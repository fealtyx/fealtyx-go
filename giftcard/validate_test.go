...
func TestValidateGiftCardCode(t *testing.T) {
	tests := []struct {
		...
		{
			name:                     "is not a fealtyx code, first 2 of last 4 characters don't match last 2",
			domain:                   "example.com",
		...
		{
			name:                     "fealtyx code - domain mismatch",
			domain:                   "example2.com",
			orderAmount:              100.0,
			phoneNumber:              "+918989898989",
			giftCardCode:             "FLX123415EG",
		...
		{
			name:                     "fealtyx code - phone mismatch",
			domain:                   "example.com",
			orderAmount:              100.0,
			phoneNumber:              "777777",
			giftCardCode:             "FLX123415EG",
		...
		{
			name:                     "valid code with hashed phone but empty domain",
			domain:                   "",
			phoneNumber:              utils.GetSHA256Hash("+918989898989"),
			giftCardCode:             "FLX123415EG",
			is_applicable:            false,
		...
		{
			name:                     "valid code with hashed phone but invalid domain",
